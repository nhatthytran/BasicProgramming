...
public class ILogTest extends TestCase{
	...
	public void testSortBySpeed() {
			...
			assertEquals(empty.sortBySpeed(), new MTLog());
			assertEquals(l1.sortBySpeed(), new ConsLog(e1, new MTLog()));
			assertEquals(l2.sortBySpeed(), new ConsLog(e1, new ConsLog(e2, new MTLog())));
	}
}
